...
2. Current operational state (distributed across `context/campaigns.md`, `skills/crm-update.skill`, `scheduler/`, and `context/` — see Section 7)
...
- Claude — AI reasoning, workflow orchestration and Skills
...
- **CRM / Zoho schema** (field mapping, field types, current field capacity) — `skills/crm-update.skill`, specifically its FIELD MAPPING section — the authoritative, schema-verified mapping.
