...
Medium to Large. **Documented pod tiers conflict between sources** — see the warning in `services.md`. Website tiers are Foundation / Growth / Enterprise; internal strategy defines Maintenance (40 hrs/month), Growth (1 full-stack + 0.5 QA), and Scale (2 devs + 1 lead + 1 QA). Confirm which is commercially active before quoting composition.
...
USD 10,000–20,000 — the documented typical current deal size.
...
**⚠️ Internal reference only. Never quote to a prospect. See the warning in [Overview](#overview).**
...
|---|---|
| Fixed-price project | **USD 10,000–20,000** typical current deal size |
| Larger dedicated pod, annualised | **USD 80,000–150,000+** |
...
- Documented deal-shape ranges (USD 10k–20k; USD 80k–150k+)
...
## Safe figures — the complete list

The only commercial numbers an agent may state to a prospect:

| Figure | Context |
|---|---|
| USD 10,000–20,000 | Typical fixed-price project size |
| USD 80,000–150,000+ | Larger dedicated pod, annualised |
| 5–10 days | Onboarding time for a team |
| 5–7 developers in 3 months | Capacity ceiling — use when qualifying out |
| 30 days notice | Scale-down terms (documented for agency pitches) |
| 2 business days | Proposal turnaround commitment |
