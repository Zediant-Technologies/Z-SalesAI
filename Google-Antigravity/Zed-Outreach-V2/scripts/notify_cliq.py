...
potential_env_paths = [
    ...
    r"C:\Work\Zediant\Sales\SalesAI\Google-Antigravity\Zed-Outreach-V2\.env",
    r"C:\Work\Zediant\Sales\SalesAI\Google-Antigravity\Zediant-Sales-Engine\.env",
    r"C:\Work\Zediant\Sales\Google-Antigravity\Zediant-Sales-Engine\.env"
]
