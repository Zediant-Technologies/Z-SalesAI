...
Sender/mailbox assignment is not tracked in this matrix or in `context/campaigns.md` — per explicit human instruction (September 2026), which account sends to a given persona does not matter to the business and is a Apollo configuration detail.
