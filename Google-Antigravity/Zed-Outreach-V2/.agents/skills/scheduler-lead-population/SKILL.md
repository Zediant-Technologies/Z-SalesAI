...
Run `email-personalization` with strict quality enforcement:
- `Personalised Email` (id: `6aa79177f203040018e0af9d`): Complete 3-Beat email body (50–90 words).
  * **Beat 1:** Product-grounded observation (must name the company's real core platform, product line, or technical domain).
  * **Beat 2:** Operational tension between scaling/speed and senior dev capacity, introducing Zediant's senior engineering squads embedding in 2–3 weeks (shipping 30–40% faster).
  * **Beat 3:** Standalone 2-minute teardown CTA (low-friction permission ask).
  * **Body only rule:** NO greetings/salutations (no `Hi {{first_name}},`) and NO signatures (no `Best,\nRajeev...`).
- `Company Trigger` (id: `6aa790eddc1736001c90b2cf`): The observable growth/tech signal.
  * **Syntax:** Must be an action/initiative phrase (e.g. `ongoing modernization of Odyssey's core loan administration and payment platform`) **WITHOUT the company name and WITHOUT a trailing period**, because the Step 2 LinkedIn template already appends `at {{company}}`.
- `Pain Point` (id: `6aa790fa8c717000101fa55c`): The specific technical problem.
  * **Merge rule:** Injected directly into Step 3 email: `"Following up on my note around {{Pain Point}}."`
  * **Syntax:** Must be a **lowercase gerund or noun phrase (6–15 words)** with NO trailing period, NO duplicate prepositions (no starting "around", "regarding", "about"). Example: `senior engineering capacity bottlenecks while scaling embedded insurance API workflows`.
- **Legal Suffix Stripping:** Before creating/updating the Apollo contact, always strip legal corporate suffixes (`Pty Ltd`, `Pty. Ltd.`, `Ltd`, `Inc`, `Inc.`, `LLC`, `Corp`, `Co.`) from `organization_name` so subject lines (`{{company}}'s product roadmap`) and email bodies render as natural conversational English.
...
{
  "typed_custom_fields": {
    "6aa77b8749beb6001c395715": 94,
    "6aa77f1d3a845200202a56d6": "Apollo",
    "6aa790d821b4e6001cb70994": "C1 - AI-Enabled Product Engineering",
    "6aa790eddc1736001c90b2cf": "Rapid partner API expansion across Open's embedded insurance platform.",
    "6aa790fa8c717000101fa55c": "senior engineering capacity bottlenecks while scaling embedded insurance API workflows",
    "6aa79157e03659000e5b1889": "Product Development",
    "6aa79177f203040018e0af9d": "Saw what you guys are building with Open's embedded insurance platform...\n\nRolling out partner APIs while keeping the core rating engine fast usually pulls senior engineers in two directions...\n\nOpen to checking a 2-minute teardown of how we helped a similar fintech product team accelerate release cycles by 35%?",
...
- `6aa790fa8c717000101fa55c`: `Pain Point` (Textarea: lowercase gerund/noun phrase completing Step 3 sentence)
- `6aa79157e03659000e5b1889`: `Outreach Angle` (Picklist: `Engineering Capacity`, `Product Development`, `Other`)
- `6aa79177f203040018e0af9d`: `Personalised Email` (Textarea: Step 1 complete 3-Beat email body only)
